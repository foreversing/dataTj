  ...
  var script = {
    ...
    methods: {
      ...
      setAppScale() {
        ...
        var scale_times=currentHeight / 1080;
        var emWidth=scale_times*1920;
       
        if(currentWidth>emWidth)
        {
          var left_offset=Math.ceil((currentWidth-emWidth)/2);
          dom.style.left=left_offset+"px";
        }
        else{
          scale_times=currentWidth/1920;
          dom.style.left="0px";
        }
        dom.style.transform = `scale(${scale_times})`;       
      },
